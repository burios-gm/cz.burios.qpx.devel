...
public class MySQLDialect implements DBDialect {
    ...
    @Override public String createIndex(TableMetaData t,IndexMetaData i){String s=DBDialect.super.createIndex(t,i);if(i.method!=null&&!i.method.isBlank())s+=" USING "+i.method;return s;}
